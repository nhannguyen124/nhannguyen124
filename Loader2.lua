...
wait(3)
local ui_link = "https://raw.githubusercontent.com/nhannguyen124/nhannguyen124/HackerLoVNLibV1.lua"
...
local a = a:Window({
    ...
    ConfigurationSaving = {
        ...
        FileName = "HackerLoConfig"
    },
    KeySystem = false, -- Set to true if you want a key system
})
local HomePage = a:Tab("Home", "rbxassetid://80935084928352")
...
HomePage:Label("Blox Fruits | Version 1.0.0")
...
HomePage:Button({
    ...
    Callback = function()
	    ...
	    setclipboard("https://discord.gg/sZ6b8KY2")
    end,
})
-----------------------------------------------------------------------------------------------------------------------------Function
